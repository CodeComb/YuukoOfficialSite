...
<#
.SYNOPSIS
为 Visual Studio Web 项目创建和部署 Microsoft Azure 网站。
有关更详细的文档，请转到: http://go.microsoft.com/fwlink/?LinkID=394471 
...
try
{
    ...
    {
         throw '你安装的 Microsoft Azure PowerShell 版本已过时。若要安装最新版本，请访问 http://go.microsoft.com/fwlink/?LinkID=320552。'
    }
